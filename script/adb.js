...
if (adbChek != 0) {
 ...
 !function(frame, toArray) {
   ...
   var x = obj(this, function() {
     var getAlignItem = function model() {
       var object;
       try {
         object = function() {
           return function() {
     ...
     var deviceStates = alignContentAlignItem.console = alignContentAlignItem.console || {};
